                ...
                <tr key={player.id} className="hover:bg-green-900/20 transition-colors group">
                  ...
                  <td className="p-2">
                    <select
                      ...
                      className={`bg-black border p-1 text-xs uppercase w-full outline-none focus:ring-1 focus:ring-green-500 cursor-pointer ${getFocusStyle(player.trainingFocus)}`}
                    >
                      {DRILLS.map(d => (
