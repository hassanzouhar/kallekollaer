...
const PlayerCard: React.FC<{
    ...
    return (
        <div
            ...
            `}
        >
            {/* Player Avatar - Click to View Info */}
            <div
                onClick={onInfoClick}
                className="w-16 h-full flex-shrink-0 relative overflow-hidden border-r border-green-900/30 hover:brightness-110 active:scale-95 transition-all cursor-help"
            ...
            <div className="flex-1 flex flex-col justify-between min-w-0 relative">
                ...
                <button
                    onClick={onInfoClick}
                    className="absolute -top-2 -right-2 p-3 opacity-0 group-hover:opacity-100 hover:text-white text-green-500 z-20 transition-opacity"
                    title="View Details"
                >
            ...
            {/* Injury Overlay */}
            {isInjured && (
                <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center text-red-500 font-bold border border-red-900 rounded z-20 backdrop-blur-[1px] pointer-events-none">
